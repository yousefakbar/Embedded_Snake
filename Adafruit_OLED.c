...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x2, 0x0); // dc low
    MAP_SPICSEnable(GSPI_BASE); // oc low
    MAP_SPIDataPut(GSPI_BASE, c); // put data/command
    MAP_SPIDataGet(GSPI_BASE, &ulRecvData);
    MAP_SPICSDisable(GSPI_BASE); // oc high
}
//*****************************************************************************
...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x2, 0x2); // dc low
    MAP_SPICSEnable(GSPI_BASE); // oc low
    MAP_SPIDataPut(GSPI_BASE, c); // put data/command
    MAP_SPIDataGet(GSPI_BASE, &ulRecvData);
    MAP_SPICSDisable(GSPI_BASE); // oc high
